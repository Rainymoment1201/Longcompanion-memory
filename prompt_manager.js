...
- 关于我(表8):当{{user}}主动透露或对话中自然流露出与其自身相关的信息时,必须记录.信息类型包括:①基础信息(姓名/昵称/年龄/生日/星座/职业/身份),②偏好习惯(兴趣爱好/饮食偏好/沟通方式/禁忌事项),③人际关系(家人/朋友/宠物),④事件记忆(重要经历/共同话题/约定事项),⑤时间节点(第一次对话/关系里程碑/影响关系的重要事件).记录时必须标注[相关程度]:高(用户直接陈述自己的信息)/中(通过对话推断出的信息)/低(背景性提及).同一类型信息必须合并到一行,使用updateRow追加更新,严禁重复建行！
