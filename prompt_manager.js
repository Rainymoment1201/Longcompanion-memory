...
- 物品追踪:仅记录具有唯一性、剧情关键性或特殊纪念意义的道具(如:神器、钥匙、定情信物、重要礼物).严禁记录普通消耗品(食物/金钱)或环境杂物.物品必须唯一！若物品已在表中,无论它流转到哪里,都必须updateRow更新其[持有者]和[当前位置],严禁新建一行！
- 约定:仅记录双方明确达成共识的严肃承诺或誓言.必须包含{{user}}的主动确认.严禁记录单方面的命令、胁迫、日常行程安排或临时口头指令.
- 关于我(表8):记录{{user}}主动透露或对话中自然流露的关于自己的信息.内容分为七大类型:①基础信息(姓名/昵称/性别/年龄/生日/职业/居住地/星座),②个人特质(性格/技能/爱好),③偏好习惯(兴趣爱好/饮食偏好/沟通方式/禁忌事项),④人际关系(家人/朋友/宠物/其他关系),⑤重要时刻(重要经历/约定事项),⑥目标规划(短期目标3个月内/长期目标1年以上),⑦强调信息({{user}}明确要求记住的内容).格式:分号分隔,如"姓名:张三;昵称:小三;性别:男;年龄:25;生日:1999-05-20;职业:程序员;居住地:北京;星座:金牛座".
